...
{
    // jammer dat je hier zelf geen klasse voor uitgeschreven hebt, dan had je nog de 
    // keuze om te kiezen welke strategypicker je gebruikte, nu heb je maar 1
    public class NaiveStrategyInitialiser
    {
            ...
            Dictionary<string, int> playingPiecesArmyCount, PieceColor pieceColor)
        {
            ...
            // dit had je beter met verschillende klassen uitgewerkt ipv hier extra controles bij te plaatsen
            // dit maakt de huidige klasse overbodig complex en de code is zo moeilijker te volgen/begrijpen
