...
namespace Stratego.Core
{
    public class GameBoard
    {
        ...
        // game ended met public setter?
        public bool GameEnded { get; set; }
        public string WinnerText { get; protected set; }
        // een public variabele? dit is bij OOP not done - toestand van een klasse dient altijd afgeschermd te worden
        ...
        private bool HasNoHorizontalObstacles(byte playingPieceRow, byte playingPieceColumn, Direction direction, int steps)//Als water is hier false returnen
        {
            ...
            for (var i = 1; i <= steps; i++)
            {
                ...
                {
                    // dit had je beter anders kunnen oplossen -> een aparte klasse zoals een pion die op het speelveld geplaatst wordt
                    ...
                    {
                        // dit zou dan in die waterplasklasse terechtkomen
